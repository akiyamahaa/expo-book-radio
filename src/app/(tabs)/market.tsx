    ...
    <SafeAreaView className="bg-white pb-6 flex-1">
      ...
      <View className="bg-[#F3F4F6] h-[48px] w-full py-2 px-4">
        <View className="bg-[#e4e7eb] w-full h-[32px] rounded-[10px] flex-row p-1">
          <TouchableOpacity onPress={() => setActiveTab("buy")} className={`w-[50%] flex justify-center items-center ${activeTab === "buy" ? "bg-white rounded-[10px]" : ""}`}>
            <Text>Mua</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setActiveTab("cell")} className={`w-[50%] flex justify-center items-center ${activeTab === "cell" ? "bg-white rounded-[10px]" : ""}`}>
            <Text>Bán</Text>
          </TouchableOpacity>
        </View>
      </View>
